...
$H_0$: The opinion on capital punishment is independent of gun ownership.
...
```
 The data shows that perfomance on the wordsum test is dependent on the level of schooling, as the values get higher overall with education. 
Numerical study shows that 75% of gun owners favor CAPPUN.
...
fisher.test(table1)
```
The Chi-square test p-value is 0.0202, Hence we reject the null hypothesis and conclude that gun ownership and captial punishment are not independent. 

The fisherexact test has a p-value of 0.01651, hence we reject the null hypothesis, as the chi-squared test. The odds ratio says that gun owners are 2.3 times more likely to be in favor of capital punishment as opposed to those who dont own a gun.
...
$H_0$:There is a dfference in years of educations between the those who did or did not vote in 2012.

$H_A$: There is no difference between education and if someone voted. 
...
```
This T-test shows that this means those who voted had a better education. Therefore we reject the null hypothesis

The P-value 0.000001248 which is less than 0.5, therefore we reject the null hypothesis.

$H_0$: The score of a persons wordsum test is independent on their level of education. 
...
This charts show that level of schooling has an affect on the WORDSUM test percentage results. 
...
This Numerical results show that in 2012 those who did vote have almost 16 years in education
...
```
The family wise confidence levels for 

There is no difference between high school and junior college. There is a difference between high school, bachelors and graduates. There is no difference between high school graduate and junior college. 
...
#### Question 1: is gun ownership indepenedent of opinion on capital punishment. 
